...
int main()
{
	...
	struct data* dtmp1;
	printf("head1 hlist:");
	hlist_for_each_entry(dtmp1, &head1, node) {
		printf(" %d --> ", dtmp1->val);	
	}
	printf("NULL\n");
	...
	printf("head1 hlist:");
	hlist_for_each_entry_continue(dtmp2, node) {
		printf(" %d --> ", dtmp2->val);	
	}
	printf("NULL\n");
	...
	printf("head1 hlist:");
	hlist_for_each_entry_from(dtmp3, node) {
		printf(" %d --> ", dtmp3->val);	
	}
	printf("NULL\n");
	...
	printf("head1 hlist:");
	hlist_for_each_entry_safe(dtmp4, hntmp, &head1, node) {
		printf(" %d --> ", dtmp4->val);	
	}
	printf("NULL\n");
